...
import WaWai from "@guide/accessibility/WaWai";
// plan
import Colors from "@guide/plan/Colors";
import Typography from "@guide/plan/Typography";
// components
import Accordion from "@guide/components/GuideAccordion";
import Modal from "@guide/components/Modal";
import BottomSheet from "@guide/components/BottomSheet";
import Swiper from "@guide/components/Swiper";
import Tab from "@guide/components/GuideTab";
...
import Checkbox from "@guide/components/Checkbox";
import Radio from "@guide/components/Radio";
import Select from "@guide/components/Select";
import Dropdown from "@guide/components/Dropdown";
import Button from "@guide/components/Button";
import Icon from "@guide/components/Icon";
// error
import NoMatch from "@guide/NoMatch";

type routeArray = {
  [key: string]: string | JSX.Element | JSX.Element[] | (() => JSX.Element);
};

function GuideRouter() {
  const [url, setUrl] = useState("");
  const location = useLocation();
  const [changeUrl, setChangeUrl] = useState<JSX.Element>();
  let id: any, values: any;
  const routeArray: routeArray = {
